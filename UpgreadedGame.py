...
canvas = Canvas(root, width=500, height=500, bd=0, highlightthickness=0, highlightbackground="black", bg="White")

URL = "https://upload.wikimedia.org/wikipedia/en/0/07/Ala-Too_International_University_Seal.png"
image_byt = urlopen(URL).read()
image_b64 = base64.encodebytes(image_byt)

image = PhotoImage(data=image_byt)
